...
var DynaNodeChannelReceiver = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.sendReceive({
                                ...
                                command: DynaNodeChannelsService_1.COMMAND_RegisterReceiver,
                                args: {
    ...
    DynaNodeChannelReceiver.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.client.stopConnections()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return DynaNodeChannelReceiver;
}());
exports.DynaNodeChannelReceiver = DynaNodeChannelReceiver;
//# sourceMappingURL=DynaNodeChannelReceiver.js.map